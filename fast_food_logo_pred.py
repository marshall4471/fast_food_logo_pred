...
zip_ref = zipfile.ZipFile("/content/logos.zip", 'r')
zip_ref.extractall()
zip_ref.close()

file1= ('/content/logos3/train')

file2= ('/content/logos3/test')
...
history= model.fit(train_gen, validation_data = test_gen, epochs=12, verbose=2)
